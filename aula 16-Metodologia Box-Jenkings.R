...
AR10 <- arima(IntegradaOrdem1, order = c(1,0,0))
AR11 <- arima(IntegradaOrdem1, order = c(1,1,0))
AR12 <- arima(IntegradaOrdem1, order = c(1,2,0))
AR13 <- arima(IntegradaOrdem1, order = c(1,3,0))
AR14 <- arima(IntegradaOrdem1, order = c(1,4,0))
AR15 <- arima(IntegradaOrdem1, order = c(1,5,0))
AR16 <- arima(IntegradaOrdem1, order = c(1,6,0))
AR17 <- arima(IntegradaOrdem1, order = c(1,7,0))
AR18 <- arima(IntegradaOrdem1, order = c(1,8,0))
AR19 <- arima(IntegradaOrdem1, order = c(1,9,0))
AR20 <- arima(IntegradaOrdem1, order = c(2,0,0))
AR21 <- arima(IntegradaOrdem1, order = c(2,1,0))
AR22 <- arima(IntegradaOrdem1, order = c(2,2,0))
AR23 <- arima(IntegradaOrdem1, order = c(2,3,0))
AR24 <- arima(IntegradaOrdem1, order = c(1,4,0))
AR25 <- arima(IntegradaOrdem1, order = c(1,5,0))
